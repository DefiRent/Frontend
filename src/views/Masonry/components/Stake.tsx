...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(rentControl.RSHARE, rentControl.contracts.Masonry.address);

  const tokenBalance = useTokenBalance(rentControl.RSHARE);
  const stakedBalance = useStakedBalanceOnMasonry();
  const { from, to } = useUnstakeTimerMasonry();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('RSHARE', rentControl.RSHARE);
