      ...
      <Container maxWidth="lg">
        <Grid container>
          ...
          <Grid item xs={6} style={{ textAlign: 'right' }}>
            <a
              href="https://twitter.com/rentcontrol"
            ...
            <a
              href="https://github.com/rentcontrol/rentcontrol-frontend"
              rel="noopener noreferrer"
              target="_blank"
              className={classes.link}
            >
            ...
            <a href="https://t.me/rentcontrol" rel="noopener noreferrer" target="_blank" className={classes.link}>
            ...
            <a href="http://discord.rend.defi/" rel="noopener noreferrer" target="_blank" className={classes.link}>
