        ...
        {matches ? (
          <>
            <Typography variant="h6" color="inherit" noWrap className={classes.toolbarTitle}>
              {/* <a className={ classes.brandLink } href="/">Rent Control</a> */}
            ...
            <Box mr={5}>
              ...
              <a href="https://docs.rend.defi" className={classes.link}>
                Docs
              </a>
            </Box>
          ...
          <>
            ...
            >
              ...
              <List>
                ...
                <ListItem button component="a" href="https://docs.rend.defi">
